...
/**
 * Nguyen Xuan Truong
 * truongnx28111994@gmail.com
 */
class Baokim_PaymentPro_Model_CallRestful {
	/**
	 ...
	 * @return mixed
	 */
	function call_API($method, $data, $api, $getConfigData = array()) {

		$business    = $getConfigData['business_account'];
		$username    = $getConfigData['api_username'];
		$password    = $getConfigData['api_password'];
		$private_key = $getConfigData['api_signature'];

		if ($getConfigData['test_mode'] == true) {
			$server = 'http://kiemthu.baokim.vn';
		} else {
			$server = 'https://www.baokim.vn';
		}
	...
	/**
	 * [httpBuildQuery description]
	 * @author Truong Nguyen
	 * @email  truongnx28111994@gmail.com
	 * @date   2015-08-13
	 * @param  [type]                     $formData      [description]
	 * @param  string                     $numericPrefix [description]
	 * @param  string                     $argSeparator  [description]
	 * @param  string                     $arrName       [description]
