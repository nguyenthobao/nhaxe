...
{ 
     ...
     * @param int $port
     */
    public function __construct($host = NULL, $username = NULL, $password = NULL, $db = NULL,$set_charset=null, $port = NULL)
    {
        $this->host = $host;
        $this->username = $username;
        $this->password = $password;
        $this->db = $db;
        $this->set_charset = $set_charset;
        if($port == NULL)
    ...
    public function connect()
    {
        ...
        $this->_mysqli->set_charset ($this->set_charset);
        unset($this->username);
        unset($this->password);
        unset($this->db);
        unset($this->port);
    ...
    /**
     * A convenient num_rows (Quang Chau Tran)
     *
     * @param string  $tableName The name of the database table to work with. 
     *
    ...
    { 
        ...
        $this->_query = "SELECT * FROM " .self::$_prefix . $tableName;
    ...
    /**
     * Check exist table (Quang Chau Tran) 
     *
     * @return boolean 
     */
