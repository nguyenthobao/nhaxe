...
class MysqliDb {
     ...
     */
    public function __construct($host = null, $username = null, $password = null, $db = null, $charset = 'utf8', $port = null) {
        global $_B;
        $this->info_cache = $_B['info_cache'];
        //$host = NULL, $username = NULL, $password = NULL, $db = NULL,$set_charset=null, $port = NULL
        $isSubQuery = false;
    ...
    public function connect() {
        ...
        // if ($this->_mysqli) {
        //     $this->_mysqli->select_db($this->db);
        //     return;
        // } else {
        //     $this->_mysqli = new mysqli($this->host, $this->username, $this->password, null, $this->port);
        //     $this->_mysqli->select_db($this->db);
        // }
    ...
    //     $this->_query = "SHOW TABLES LIKE '".self::$_prefix . $tableName."'";
