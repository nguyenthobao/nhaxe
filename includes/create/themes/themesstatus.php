...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
     <title>BNC Group - Themes Store - <? if(!empty($_DATA['search'])) { echo $_DATA['search']; } ?></title>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <ol class="breadcrumb wow zoomIn data-wow-duration="1s" data-wow-delay="0.1s"">
                            ...
                            <li class="active"><?php echo $_DATA['search']; ?></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form action="" method="POST" role="form" class="searh_products wow zoomIn data-wow-duration="1s" data-wow-delay="0.9s"">
                        <div class="form-group">
                            <input type="text" class="form-control searh_products_input" id="searh_products_input" placeholder="Từ khóa tìm kiếm" value="">
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="top_products_box wow fadeInUp data-wow-duration="0.2s" data-wow-delay="0.2s"">
                                ...
                                <?php if($_DATA['active']==1) { ?>
                                    <h2><span class="top_products_text">Giao diện</span></h2>
                                <?php }else{ ?>   
                                    <h2>Giao diện <span class="top_products_text"><?php echo $_DATA['search']; ?></span></h2>
                                <?php }?> 
