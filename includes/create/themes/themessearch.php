...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
     <title>BNC Group - Themes Store - <? if(!empty($_DATA['search'])) { ?> "<?php echo $_DATA['search']; ?>" <?php } ?></title>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form action="" method="POST" role="form" class="searh_products wow zoomIn data-wow-duration="1s" data-wow-delay="0.9s"">
                        <div class="form-group">
                            <input type="text" class="form-control searh_products_input" id="searh_products_input" placeholder="Từ khóa tìm kiếm" value="<?php echo $_DATA['title_search']; ?>">
                        </div>
                        <button type="button" class="searh_products_action" value=""></button>
                    </form>
                </div>
                <div class="col-md-9 col-md-offset-30">
                    <form action="" class="hiden-md visible-xs wow zoomIn data-wow-duration="0.5s" data-wow-delay="0.4s"">
                        <div class="form-group">
                    ...
                    <div class="hidden-xs link_categories wow zoomIn data-wow-duration="0.5s" data-wow-delay="0.4s"">
                         <ul>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="top_products_box wow fadeInUp data-wow-duration="0.2s" data-wow-delay="0.2s"">
                                <div class="top_products_title">
                                 <h2>Kết quả tìm kiếm với <span class="top_products_text"><?php echo $_DATA['title_search']; ?></span> gồm</h2>
                ...
                ?>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                        <div class="top_products_box_info data-wow-duration="0.2s" data-wow-delay="0.2s"">
                            <figure>
                                <a href="<?php echo $v['link'];?>" title="<?php echo $v['title'] ?>"><img src="<?php echo loadImage($v['img'], 'none', 0, 0); ?>" alt="<?php echo $v['title'] ?>"></a>
                            </figure>
                            <figcaption>
