...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
     <title>BNC Group - Themes Store </title>
     <meta name="Description" content="" />
    <meta name="Keywords" content="BNC Group,Themes Store,kho giao dien, thiet ke web" />  
    <meta property=”og:site_name” content="Thiết kế website chuyên nghiệp Webbnc.net"/>
    <meta property=”og:url” content="<?php echo $_B['current_url']; ?>" />
    <meta property=”og:title” content="BNC Group - Themes Store" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="logo">
                        <h1><a href="http://themes.webbnc.net/<?php echo $_DATA['link_svg']; ?>" title="BNC_Group"><img src="/includes/create/themes//themesstore/images/logo2.png" alt="BNC group"></a></h1>
                    </div>  
                </div>
                <!-- End Logo -->
                <!-- Menu Mobile -->
...
<section class="content_main">
    ...
    <!-- <section id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="<?php echo $_B['static'] ?>/themesstore/images/banner_slideshow.jpg" alt="Chania" width="100%" height="500">
            <div class="box_info_slideshow">
                <figure>
                    <img src="<?php echo $_B['static'] ?>/themesstore/images/image_slideshow_banner.png" class="slideshow_img_inner animated bounceInLeft" alt="THEME STORE BNC">
                </figure>
                <figcaption>
                    <h3 class="animated bounceInLeft slideshow_title animated bounceInTop">THEME STORE BNC</h3>
                    <p class="slideshow_info short_slideshow animated bounceInRight">Bạn là web designer/ developer? Bạn muốn tăng thêm thu nhập?
                    Tham gia thiết kế và kinh doanh theme trên BNC với chính sách hấp dẫn. </p>
                    <img src="<?php echo $_B['static'] ?>/themesstore/images/image_register.png" alt="THEME STORE BNC" class="slideshow_img_register animated bounceInRight">
                    <a href="http://v2.webbnc.net/" class="slideshow_btn_action animated bounceInUp">Đăng ký ngay</a> 
                </figcaption>
            </div>
          </div>
    ...
    <!-- Slider Customer -->
    <section class="slider_introduction_main">
        <div class="slider_introduction_inner data-wow-duration="1s" data-wow-delay="1s"">
            <div class="slider_introduction_owl" class="owl-carousel owl-theme">
                <figure class="slider_introduction_img">
                    <a href=""><img src="<?php echo $_B['static'] ?>/themesstore/images/banner_products.jpg" alt="#"></a>
                </figure>
                ...
                <div class="col-md-6 col-md-offset-3">
                 ...
                 <div class="col-md-9 col-md-offset-30">
                    ...
                    <div class="hidden-xs link_categories wow zoomIn data-wow-duration="0.5s" data-wow-delay="0.2s"">
                         <ul>
                                <li><a href="/themesstore-all.html<?php echo $_DATA['link_svg']; ?>">Tất cả</a></li>
    ...
    <section class="top_products_main">
        <div class="container">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="top_products_box wow fadeInUp data-wow-duration="0.2s" data-wow-delay="0.2s"">
                                <div class="top_products_title">
                                    <h2>Top <span class="top_products_text">giao diện</span> mới nhất</h2>
                ...
                foreach ($_DATA['themes_new'] as $k => $v)
                {
                ?>
        ...
        <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="top_products_box wow fadeInUp data-wow-duration="0.2s" data-wow-delay="0.2s"">
                                <div class="top_products_title">
                                    <h2>Top <span class="top_products_text">giao diện</span> được yêu thích nhất</h2>
                                    <p>Bạn có thể tự tạo theme của riêng bạn hoặc chọn các theme có sẵn được thiết kế và hỗ trợ bởi những partner có nhiều kinh nghiệm trong lĩnh vực online.</p>
                                </div>
                        </div>
                    </div>
                ...
                foreach ($_DATA['themes_star'] as $k => $v)
                {
                ?>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                        <div class="top_products_box_info data-wow-duration="0.2s" data-wow-delay="0.2s"">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp data-wow-duration="1s" data-wow-delay="0.2s"">
            <div class="newsletter">
                ...
                <p> <a href="http://gia247.com/<?php echo $_DATA['link_svg']; ?>">Gia247.com</a> - <a href="http://bncgroup.com.vn/<?php echo $_DATA['link_svg']; ?>">BNCGroup.com.vn</a>
                </p>
        ...
        <div class="col-md-5 col-sm-6 col-xs-12 wow fadeInUp data-wow-duration="1s" data-wow-delay="0.3s"">
            <div class="contact-details">
                ...
                <ul class="contact">
                    <li>
                        <p><i class="fa fa-map-marker"></i> <strong>Trụ sở chính:</strong> Trụ sở chính: Tầng 8, 51 Lê Đại Hành, Hai Bà Trưng, Hà Nội, Việt Nam</p>
                    </li>
                    <li>
