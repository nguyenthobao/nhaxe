...
<head>
    <meta charset="UTF-8">
     ...
     <title>BNC Group - Themes Store - <? if(!empty($_DATA['detail'])) {  echo $_DATA['detail']['title']; } ?></title>
    ...
    <link rel="stylesheet" href="<?php echo $_B['static'] ?>/themesstore/css/style.css?v=29">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="logo">
                        <h1><a href="http://themes.webbnc.net/<?php echo $_DATA['link_svg']; ?>" title="BNC_Group"><img src="<?php echo $_B['static'] ?>/themesstore/images/logo2.png" alt="Ê"></a></h1>
                    </div>  
                </div>
                <!-- End Logo -->
                <!-- Menu Mobile -->
...
<section class="content_main">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <ol class="breadcrumb wow zoomIn data-wow-duration="1s" data-wow-delay="0.1s"">
                            ...
                            <li class="active"><?php echo $_DATA['detail']['title']; ?></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form action="" method="POST" role="form" class="searh_products wow zoomIn data-wow-duration="1s" data-wow-delay="0.9s"">
                        <div class="form-group">
                            <input type="text" class="form-control searh_products_input" id="searh_products_input" placeholder="Từ khóa tìm kiếm">
                        </div>
                        <button type="button" class="searh_products_action" value=""></button>
                    </form>
                </div>
                    ...
                    <form action="" class="hiden-md visible-xs wow zoomIn data-wow-duration="0.5s" data-wow-delay="0.2s"">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="sel1">
                                <option <?php if($_DATA['active']==1) { ?>class="active" <?php }?>><a href="/themesstore-all.html<?php echo $_DATA['link_svg']; ?>">Tất cả</a></option>
    ...
    <!-- Modal Theme Details-->
      <div class="theme_details">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 wow bounceInLeft data-wow-duration="0.5s" data-wow-delay="0.4s"">
                    <div class="modal_box">
                        <h1 class="modal_title"><?php echo $_DATA['detail']['title']; ?></h1>
                        <div class="modal_info">
                            

                             <?php if(number_format($_DATA['detail']['price'], 0, ',', '.')==0){ ?>
                            <p class="modal_price">Miễn phí</p>
                            <?php 
                            }else{
                            ?>
                            <p class="modal_price"><?php echo number_format($_DATA['detail']['price'], 0, ',', '.');?> vnđ</p>
                            <?php } ?>

                            <?php if(number_format($_DATA['detail']['price'], 0, ',', '.')==0){ ?>
                            <p><a href="http://v2.webbnc.net/?temp=<?php echo $_DATA['detail']['sub_id']; ?>" class="modal_use_tempale">Sử dụng giao diện này</a></p>
                            <?php } else {?>
                                 <p><a href="javascript:" class="modal_use_tempale"> Vui lòng liên hệ tới 19002008</a></p>
                            <?php } ?>     
                            <input type="hidden" id="id_sub" name="id_sub" value="<?php echo $_DATA['detail']['sub_id']; ?>">
                            <p class="modal_select">hoặc</p>
                            <p><a href="<?php echo $_DATA['link_demo']; ?>" class="modal_review_template">Xem trước giao diện</a></p>
                        </div>
                        <div class="modal_contact">
                            <p>Bạn còn thắc mắc, vui lòng liên hệ <span class="modal_contact_phone">1900.2008</span><br />
                            Hoặc: support@ibnc.vn</p>
                        </div>
                    </div>
               </div>
              
               <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 img_themes wow bounceInRight data-wow-duration="0.5s" data-wow-delay="0.7s"">
                   <figure class="img_themes_big">
                      <a href=""><img src="<?php echo loadImage($_DATA['detail']['img'], 'none', 0, 0); ?>" alt="<?php echo $_DATA['detail']['title']; ?>" class="img-responsive modal_img"></a>
                   </figure>
                   <figure class="themes_mobile">
                        <div class="themes_mobile_bg">
                            <div class="themes_mobile_screen">
                    
                                <div class="bg_thumb1" style="background: url('<?php if (!empty($_DATA['detail']['anh1'])) { echo loadImage($_DATA['detail']['anh1'], 'none', 0, 0); }else{ echo loadImage($_DATA['detail']['img'], 'none', 0, 0); }?>');"></div>
                            </div>
                        </div>
                   </figure>
               </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="modal_box_contact_main">
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="modal_description">
                                        ...
                                        <div class="fb-comments" data-href="https://www.facebook.com/BNCvietnam/?ref=ts&amp;fref=ts" data-width="1150" data-numposts="5"></div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="modal_themes_more">
                        <h3>Các Giao Diện Khác</h3>
                        <div class="row">
                        <?php foreach ($_DATA['themes_other'] as $k => $v) {if ($k < 3) {?>
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="modal_themes_box">
                                    <figure>
                                        <a title="<?php echo $v['title'] ?>" href="<?php echo $v['link'] ?>"><img src="<?php echo loadImage($v['img'], 'none', 0, 0); ?>" alt="<?php echo $v['title'] ?>"></a>
                                    </figure>
                                    <figcaption>
                                        <h4><a title="<?php echo $v['title'] ?>" href="<?php echo $v['link'] ?>"><?php echo $v['title'] ?></a> <i class="fa fa-heart-o icon_heart"></i></h4>
                                        <p class="modal_themes_star">
                                        ...
                                        <p class="modal_themes_code">Miễn phí</p>

                                        <?php 
                                        }else{
                                        ?>
                                   
                                        <p class="modal_themes_code"><?php echo number_format($v['price'], 0, ',', '.');?> vnđ</p>
                ...
                <div class="contact_inner">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <figure class="contact_inner_images wow zoomIn data-wow-duration="1s" data-wow-delay="1.3s"">
                            <img src="<?php echo $_B['static'] ?>/themesstore/images/info_contact.png" alt="#" class="img-responsive">
                        </figure>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp data-wow-duration="1s" data-wow-delay="0.2s"">
            <div class="newsletter">
                ...
                <p> <a href="http://gia247.com">Gia247.com</a> - <a href="http://bncgroup.com.vn<?php echo $_DATA['link_svg']; ?>">BNCGroup.com.vn</a>
                </p>
